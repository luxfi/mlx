...
constant uint N_DEFAULT = 1024;    // Polynomial degree
constant uint K_DEFAULT = 1;       // GLWE dimension
constant uint L_DEFAULT = 3;       // Gadget decomposition levels
constant uint BG_BITS_DEFAULT = 8; // Bg = 2^8 = 256
