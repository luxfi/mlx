...
constant int REJECTION_BOUND = 1 << 18;
constant ulong N_INV = 8347649UL;

// Verification bounds
constant int BETA_BOUND = 1 << 19;        // Bound on z norm
constant int DELTA_BOUND = 1 << 10;       // Bound on Delta norm
